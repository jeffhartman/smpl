...
(function () {
  ...
  var _iterator = _createForOfIteratorHelper(document.querySelectorAll('[data-toggle="tooltip"]')),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var tooltipElement = _step.value;
      new _bootstrap__WEBPACK_IMPORTED_MODULE_0__.Tooltip(tooltipElement);
    }
  ...
  var _iterator2 = _createForOfIteratorHelper(document.querySelectorAll(".toast")),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var toastElement = _step2.value;
      new _bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(toastElement);
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
